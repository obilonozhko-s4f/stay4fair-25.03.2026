 ...
 * - [UX]: Скрытие формы регистрации для авторизованных пользователей с сохранением стилей кнопки.
 */
final class OnboardingProvider
{
    ...
    public function renderOnboardingForm(): string
    {
        ...
        if (is_user_logged_in()) {
                    ...
                    <form id="sf-onboarding-form" method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" autocomplete="off">
                        ...
                        <div class="sf-form-grid">
                            ...
                            <div class="sf-form-group sf-col-2" style="position:relative;">
                                ...
                                <input type="password" id="sf_pass" name="owner_pass" autocomplete="new-password" data-lpignore="true" required>
                                <span onclick="toggleSfPass()" class="sf-pass-toggle" title="Passwort anzeigen">👁️</span>
                            </div>

                            <div class="sf-form-group sf-col-2">
                                <label>Passwort wiederholen *</label>
                                <input type="password" id="sf_pass_confirm" name="owner_pass_confirm" autocomplete="new-password" data-lpignore="true" required>
                            </div>
            ...
            <?php
        } // Конец условия is_user_logged_in()
        ?>

        <style>
            /* === ONBOARDING FORM CSS === */
            /* RU: Стили загружаются всегда, чтобы кнопка 3D работала и для плашки авторизованных */
